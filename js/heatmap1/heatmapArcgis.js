define([
    ...
    "esri/geometry/Point"
],function (declare,lang,on,domStyle,query,screenUtils,DynamicMapServiceLayer,Point) {
    var obj = declare("HeatmapLayer",[DynamicMapServiceLayer],{
        // variables
        properties: {},
        heatMap: null,
        constructor: function (properties) {
            ...
            this.globalMax = 0;
            // connect on resize
            on(this._map, "resize", this, this.resizeHeatmap);
        ...
        parseHeatmapData: function (features) {
            ...
            if (features) {
                ...
                for (i = 0; i < features.length; i++) {
                    ...
                    dataPoint = new Point(features[i].geometry);
                    // check point
